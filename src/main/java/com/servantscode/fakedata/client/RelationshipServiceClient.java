...
public class RelationshipServiceClient extends AbstractServiceClient {
    ...
    public void createRelationship(List<Map<String, Object>> data, boolean createReciprocals) {
        ...
        if(response.getStatus() == 204)
            System.out.println("Created relationship for: " + data.get(0).get("personName"));
        else
